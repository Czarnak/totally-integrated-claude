...
| Process launch permission | `Siemens.Engineering.AddIn.Permissions.dll` | `ProcessStartPermission`, `ProcessStartPermissionAttribute` | n/a | n/a |
| Process utility wrapper | `Siemens.Engineering.AddIn.Utilities.dll` | `Siemens.Engineering.AddIn.Utilities.Process`, `ProcessStartInfo` | n/a | n/a |
